...
function Footer() {
  return (
    <footer className="border-t border-white/5 px-4 py-14">
      <div className="max-w-7xl mx-auto">

        {/* Top row */}
        <div className="flex flex-col sm:flex-row flex-wrap gap-10 justify-between mb-12">
          ...
          <div className="max-w-[220px]">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <p className="text-white font-extrabold text-base leading-none">GrowRise</p>
                <p className="text-gray-600 text-[9px] tracking-[0.2em] uppercase leading-none mt-0.5">Agency</p>
              </div>
            </div>
            <p className="text-gray-500 text-xs leading-relaxed">
              Profit-driven eCommerce growth systems that scale your brand from 5 to 6 figures — and beyond.
            </p>
          </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-gray-300 font-semibold text-xs uppercase tracking-widest mb-4">Services</h4>
            <ul className="flex flex-col gap-2.5">
              {serviceLinks.map(l => (
                <li key={l}>
                  <Link to="#" className="text-gray-500 hover:text-white text-xs transition-colors">{l}</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-3 mt-3">
                {/* Instagram */}
                <a href="#" className="w-8 h-8 glass rounded-lg flex items-center justify-center text-gray-500 hover:text-white transition-colors">
